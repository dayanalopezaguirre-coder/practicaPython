...
HOST = '192.168.137.86' # ip del servidor de jacqueline en prueba
#PORT = 65432         # Debe coincidir con el puerto del servidor
PORT = 12345     # puerto del servidor de jacqueline en prueba
...
def main():
    print('Bienvenido al chat de informatica 7mo')
    ...
    try:
        ...
        #si deseas preguntar el host comenta estas 2 lineas
        host = HOST
        port = PORT
